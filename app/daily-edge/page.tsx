...
const FEED_ITEMS: FeedItem[] = [
  ...
  },
  {
    ...
    body: "Your highest volume hour isn't always your most profitable. Friday 6-7pm pushes the most orders, but Tuesday 5-6pm runs a 22% higher average ticket with 15% lower labor cost per order. Volume and profit aren't the same thing.",
  ...
  },
  {
    ...
    body: "Your top 5 sellers account for 62% of all orders. A $0.50 increase on each generates an estimated $1,840/month in additional revenue — with zero additional cost. That's pure margin.",
  ...
  },
  {
    ...
    body: "Detroit-style and Sicilian pizza searches are up 34% year-over-year. Three new square pizza concepts opened in Northeast Ohio in the last 90 days. Detroit-style margins tend to run 3-5% higher than traditional round — simpler topping patterns and a cheaper cheese blend.",
