...
export function BottomNav() {
  ...
  return (
    <>
            ...
            <div className="flex-1">
              ...
              <NavSection
                ...
                items={(() => {
                  ...
                  { href: "/inspection-radar", icon: Shield, label: "Are We Winning?", desc: "Market position vs competitors", color: "text-blue-400" },
      ...
      <nav
        className="bottom-nav bottom-nav-fixed fixed bottom-0 left-0 right-0 z-[60] bg-zinc-900 border-t border-zinc-800"
