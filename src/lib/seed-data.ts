...
export const SEED_INVENTORY: SeedInventoryItem[] = [
  { id: "i1", name: "Mozzarella", category: "cheese", par_level: 40, current_count: 32, unit: "lb", unit_cost: 3.85, last_order_date: daysAgo(2), last_counted: daysAgo(0), vendor: "Sysco" },
  { id: "i2", name: "Pepperoni", category: "meats", par_level: 25, current_count: 18, unit: "lb", unit_cost: 4.25, last_order_date: daysAgo(1), last_counted: daysAgo(0), vendor: "Sysco" },
  { id: "i3", name: "Sausage", category: "meats", par_level: 20, current_count: 22, unit: "lb", unit_cost: 3.20, last_order_date: daysAgo(3), last_counted: daysAgo(1), vendor: "US Foods" },
  { id: "i4", name: "Dough Flour", category: "dough_dry", par_level: 50, current_count: 38, unit: "lb", unit_cost: 0.42, last_order_date: daysAgo(5), last_counted: daysAgo(1), vendor: "Sysco" },
  { id: "i5", name: "Sauce (Canned)", category: "sauces", par_level: 24, current_count: 16, unit: "can", unit_cost: 8.50, last_order_date: daysAgo(4), last_counted: daysAgo(2), vendor: "US Foods" },
  { id: "i6", name: "Green Peppers", category: "produce", par_level: 15, current_count: 3, unit: "lb", unit_cost: 1.20, last_order_date: daysAgo(1), last_counted: daysAgo(0), vendor: "Local Produce Co" },
  { id: "i7", name: "Onions", category: "produce", par_level: 20, current_count: 14, unit: "lb", unit_cost: 0.65, last_order_date: daysAgo(1), last_counted: daysAgo(0), vendor: "Local Produce Co" },
  { id: "i8", name: "Mushrooms", category: "produce", par_level: 12, current_count: 2, unit: "lb", unit_cost: 2.40, last_order_date: daysAgo(2), last_counted: daysAgo(1), vendor: "Local Produce Co" },
  { id: "i9", name: "Olives", category: "produce", par_level: 10, current_count: 0, unit: "lb", unit_cost: 1.85, last_order_date: daysAgo(3), last_counted: daysAgo(0), vendor: "Sysco" },
  { id: "i10", name: "Chicken", category: "meats", par_level: 30, current_count: 24, unit: "lb", unit_cost: 2.85, last_order_date: daysAgo(2), last_counted: daysAgo(1), vendor: "US Foods" },
  { id: "i11", name: "Wing Sauce", category: "sauces", par_level: 6, current_count: 4, unit: "bottle", unit_cost: 5.20, last_order_date: daysAgo(5), last_counted: daysAgo(3), vendor: "Sysco" },
  ...
  { id: "i14", name: "Napkins", category: "paper", par_level: 20, current_count: 14, unit: "sleeve", unit_cost: 12.00, last_order_date: daysAgo(7), last_counted: daysAgo(5), vendor: "Sysco" },
  { id: "i15", name: "Gloves", category: "paper", par_level: 15, current_count: 11, unit: "box", unit_cost: 18.00, last_order_date: daysAgo(5), last_counted: daysAgo(3), vendor: "Sysco" },
  ...
  { id: "i17", name: "Lettuce", category: "produce", par_level: 12, current_count: 8, unit: "head", unit_cost: 1.40, last_order_date: daysAgo(1), last_counted: daysAgo(0), vendor: "Local Produce Co" },
  { id: "i18", name: "Bread Rolls", category: "dough_dry", par_level: 60, current_count: 42, unit: "ea", unit_cost: 0.35, last_order_date: daysAgo(2), last_counted: daysAgo(1), vendor: "Sysco" },
  { id: "i19", name: "Garlic Butter", category: "sauces", par_level: 8, current_count: 5, unit: "lb", unit_cost: 2.15, last_order_date: daysAgo(3), last_counted: daysAgo(2), vendor: "Sysco" },
  { id: "i20", name: "Parmesan", category: "cheese", par_level: 8, current_count: 6, unit: "lb", unit_cost: 4.80, last_order_date: daysAgo(2), last_counted: daysAgo(0), vendor: "Sysco" },
];
...
export const SEED_PARTY_ORDERS: SeedPartyOrder[] = [
  ...
  { id: "p3", customer_name: "Stow Youth Soccer", party_date: daysAgo(-12), party_time: "17:30", guest_count: 22, items: [{ name: "12\" Cheese", qty: 10, price: 10.99 }, { name: "12\" Pepperoni", qty: 6, price: 12.99 }, { name: "Garlic Knots", qty: 6, price: 5.99 }], subtotal: 198.52, tax: 15.88, total: 214.40, deposit_paid: 0, status: "pending", store_id: "aurora" },
...
export const SEED_TRUSTED_CONTACTS: SeedContact[] = [
  { id: "c1", name: "Mike Torres", category: "vendor", phone: "(330) 555-0122", email: "mtorres@sysco.com", notes: "Primary rep — Kent & Stow" },
  { id: "c2", name: "Jennifer Walsh", category: "vendor", phone: "(330) 555-0198", email: "jwalsh@usfoods.com", notes: "US Foods — Ravenna" },
...
export const SEED_INVOICES: SeedInvoice[] = [
  {
    ...
    invoice_number: "UF-88492",
    invoice_date: daysAgo(3),
    total: 2340,
    status: "Processed",
    created_at: new Date(Date.now() - 3 * 86400000).toISOString(),
    line_items: [
      { product: "Mozzarella 5#", qty: 12, unit: "case", unit_price: 54.17, extended_price: 650.00 },
      { product: "Pepperoni 5#", qty: 8, unit: "case", unit_price: 56.25, extended_price: 450.00 },
      { product: "Sauce #10 can", qty: 24, unit: "case", unit_price: 29.17, extended_price: 700.00 },
      { product: "Flour 50#", qty: 10, unit: "bag", unit_price: 20.00, extended_price: 200.00 },
      { product: "Dough balls 16\"", qty: 6, unit: "case", unit_price: 25.00, extended_price: 150.00 },
      { product: "Olive oil 1 gal", qty: 4, unit: "ea", unit_price: 15.00, extended_price: 60.00 },
      { product: "San Marzano  #10", qty: 6, unit: "case", unit_price: 21.67, extended_price: 130.00 },
    ],
  },
  {
    id: "inv2",
    vendor_name: "Sysco",
    invoice_number: "SYS-112847",
    invoice_date: daysAgo(5),
    total: 1876,
    status: "Processed",
    created_at: new Date(Date.now() - 5 * 86400000).toISOString(),
    line_items: [
      { product: "Chicken wings case", qty: 4, unit: "case", unit_price: 98.00, extended_price: 392.00 },
      { product: "Wing sauce 1 gal", qty: 6, unit: "ea", unit_price: 22.00, extended_price: 132.00 },
      { product: "Ranch 1 gal", qty: 4, unit: "ea", unit_price: 18.50, extended_price: 74.00 },
      { product: "Fryer oil 35#", qty: 3, unit: "case", unit_price: 52.00, extended_price: 156.00 },
      { product: "Lettuce case", qty: 8, unit: "case", unit_price: 28.00, extended_price: 224.00 },
      { product: "Tomatoes 25#", qty: 4, unit: "box", unit_price: 42.00, extended_price: 168.00 },
      { product: "Green peppers 12ct", qty: 10, unit: "case", unit_price: 24.00, extended_price: 240.00 },
      { product: "Onions 50#", qty: 2, unit: "bag", unit_price: 32.00, extended_price: 64.00 },
      { product: "Mushrooms sliced", qty: 6, unit: "case", unit_price: 38.00, extended_price: 228.00 },
      { product: "Garlic butter", qty: 12, unit: "lb", unit_price: 3.25, extended_price: 39.00 },
      { product: "Parmesan 5#", qty: 4, unit: "case", unit_price: 39.75, extended_price: 159.00 },
      { product: "Kosher salt 50#", qty: 1, unit: "bag", unit_price: 20.00, extended_price: 20.00 },
    ],
  },
  {
    id: "inv3",
    vendor_name: "Local Dairy",
    invoice_number: "LD-4421",
    invoice_date: daysAgo(1),
    total: 680,
    status: "Processed",
    created_at: new Date(Date.now() - 1 * 86400000).toISOString(),
    line_items: [
      { product: "Whole milk 1 gal", qty: 24, unit: "ea", unit_price: 4.20, extended_price: 100.80 },
      { product: "Heavy cream 1 qt", qty: 12, unit: "ea", unit_price: 6.50, extended_price: 78.00 },
      { product: "Butter 1 lb", qty: 20, unit: "ea", unit_price: 5.31, extended_price: 106.20 },
      { product: "Ricotta 5#", qty: 6, unit: "ea", unit_price: 28.00, extended_price: 168.00 },
      { product: "Sour cream 5#", qty: 4, unit: "ea", unit_price: 18.50, extended_price: 74.00 },
      { product: "Half & half 1 gal", qty: 8, unit: "ea", unit_price: 8.25, extended_price: 66.00 },
      { product: "Cream cheese 3#", qty: 4, unit: "ea", unit_price: 12.25, extended_price: 49.00 },
      { product: "Yogurt 32 oz", qty: 12, unit: "ea", unit_price: 3.25, extended_price: 39.00 },
    ],
  },
  {
    id: "inv4",
...
export const SEED_TASKS: SeedTask[] = [
  ...
  { id: "seed-t6", store_id: "kent", title: "Train Marcus on close", category: "closing", assigned_role: "shift_lead", due_date: daysAgo(1), due_time: null, status: "pending", priority: "medium", completed_by: null, completed_at: null, created_at: seedNow(), updated_at: seedNow(), is_recurring: false, recurrence: null, notes: null, created_by: null },
  { id: "seed-t7", store_id: "kent", title: "Fix walk-in thermostat", category: "custom", assigned_role: "manager", due_date: daysAgo(0), due_time: null, status: "pending", priority: "high", completed_by: null, completed_at: null, created_at: seedNow(), updated_at: seedNow(), is_recurring: false, recurrence: null, notes: null, created_by: null },
  { id: "seed-t8", store_id: "kent", title: "Post job listing for driver", category: "custom", assigned_role: "manager", due_date: daysAgo(5), due_time: null, status: "pending", priority: "low", completed_by: null, completed_at: null, created_at: seedNow(), updated_at: seedNow(), is_recurring: false, recurrence: null, notes: null, created_by: null },
];
